...
<body>
  <header id="header">
    <nav aria-label="Primary navigation">
      <div class="logo" tabindex="0">Hello, </div>
      <div class="nav-links">
        <a href="#features" tabindex="0">Request Document</a>
        <a href="#report" tabindex="0">Report Incident</a>
        <a href="" tabindex="0">View reports</a>
        <a href="{{ route('user.report.userDashboardReporting') }}" tabindex="0">User Dashboard</a>
      </div>
    </nav>
  </header>
  <main>
